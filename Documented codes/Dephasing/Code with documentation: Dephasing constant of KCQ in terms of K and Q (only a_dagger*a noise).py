...
def dephasing_time(K_Hz, Q):
    ...
    kappa_thermal = 0  # no photon gain (would correspond to 0 temperature)
...
contour = plt.contour(
    ...
    Q / 1e6,
    decay_constants.T,
    levels=np.array([2.7e3, 3e3, 3.5e3, 4e3, 4.5e3, 5e3]),
    cmap=viridis_r,
)
...
legend_labels = ["2700", "3000", "3500", "4000", "4500", "5000"]
legend_colors = [
